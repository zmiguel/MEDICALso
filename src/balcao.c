...
#define SERVER_FIFO "np_balcao"
#define CLIENTE_FIFO "np_cliente_%d"
...
int main(int argc, char **argv, char **envp) {
    ...
    U_B clientes[maxClientes];
    M_B medicos[maxMedicos];
    ...
    s_fifo_fd = open(SERVER_FIFO, O_RDWR | O_NONBLOCK);
    if (s_fifo_fd == -1) {
